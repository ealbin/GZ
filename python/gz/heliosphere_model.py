...
def solarSunspot(cartesian_pos):
    ...
    for dipole_theta in dipole_thetas:
        ...
        rel_polar     = coordinates.cartesian2polar(rel_cartesian)['rtz']
        ...
        polar_B     = np.array([ B_rho, B_theta, B_z ])
        cartesian_B = coordinates.polar2cartesian(rel_polar, vec=polar_B)['vec']
...
def sumBfieldTesla(cartesian_pos):
    ...
    return B_total * units.Change.gauss_to_tesla # [Tesla]